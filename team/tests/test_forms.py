...
class TestMatchForm(TestCase):
    ...
    def setUp(self):
        ...
        self.team = Team.objects.create(name='Sheffield Wednesday', country='England', contributor=self.user)
    ...
    def test_competition_choices_are_set(self):
        ...
        expected_choices = [('Championship', 'Championship'), ('FA Cup', 'FA Cup')]
    ...
    def test_competition_dropdown_uses_season_competitions(self):
        ...
        form = MatchForm(season=self.season)
        self.assertIn(('Championship', 'Championship'), form.fields['competition'].choices)
